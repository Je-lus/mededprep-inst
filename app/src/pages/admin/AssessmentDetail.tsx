...
export default function AssessmentDetail() {
  ...
  const handleStudentReviewToggle = async (allowStudentReview: boolean) => {
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : 'Unable to update student review setting',
      );
    }
  };
      ...
      <AlertDialog open={isCloseDialogOpen} onOpenChange={setIsCloseDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Students will no longer be able to submit responses. You can reactivate it later if
              needed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
